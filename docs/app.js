...
function hero() {
  return `<div class="hero"><div class="hero-top"><div class="brand-lockup"><div class="app-mark">24K</div><div><h1>Multi-Barcode Manager</h1><p>Manage alternate barcodes for Shopify variants so POS staff can scan changing manufacturer UPCs without searching manually.</p></div></div><div class="hero-badges"><span class="pill">Shopify Admin</span><span class="pill">POS Scanner Ready</span><span class="pill">Variant Metafields</span></div></div><div class="quick-grid"><div class="quick-card"><strong>1. Search</strong><span>Find a variant by product name, SKU, native barcode, or UPC.</span></div><div class="quick-card"><strong>2. Manage</strong><span>Add every valid alternate barcode used by suppliers or new batches.</span></div><div class="quick-card"><strong>3. Scan in POS</strong><span>The POS tile reads this same data and adds the correct product to cart.</span></div></div></div>`;
}
...
function renderResults() {
  if (!state.hasSearched && !state.searching) return `<div class="card stack" style="text-align:center"><h2>Search for a product or variant</h2><p>Use the search field above to find a product or variant by name, SKU, or barcode. Start with a brand name like “Monster” or paste a UPC.</p></div>`;
